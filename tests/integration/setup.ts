...
class TestAuthServer {
  ...
  private authenticate(req: any): any {
    ...
    const users: Record<string, { password: string; user_id: number; groups?: string[] }> = {
      ...
      'fallback_user': { password: 'password1', user_id: 53 },
      'large_packet_user': { password: 'password1', user_id: 54 },
      'packet_format_user': { password: 'password1', user_id: 55 },
      'perf_test_user': { password: 'password1', user_id: 56 },
      'random_payload_user': { password: 'password1', user_id: 57 },
      'tcp_receiver': { password: 'password1', user_id: 58 },
      'tcp_sender': { password: 'password1', user_id: 59 },
      'tcp_to_udp_receiver': { password: 'password1', user_id: 60 },
      'tcp_to_udp_sender': { password: 'password1', user_id: 61 },
      'tcp_user': { password: 'password1', user_id: 62 },
      'udp_to_tcp_receiver': { password: 'password1', user_id: 63 },
      'udp_to_tcp_sender': { password: 'password1', user_id: 64 },
