...
async function startRustEdgeServer(
  ...
  if (extraConfig) {
    ...
    const merged: Record<string, unknown> = Object.assign({}, configObj, extraConfig);
    ...
    if (extraConfig.hub_server && configObj.hub_server) {
      merged.hub_server = Object.assign(
        {},
        configObj.hub_server as Record<string, unknown>,
        extraConfig.hub_server as Record<string, unknown>,
      );
    }
    config = merged;
  }
