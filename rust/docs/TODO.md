...
#### C-02: crypto.rs 中 RNG 失败导致 panic
...
#### C-03: crypto.rs 中 AES 初始化 panic
...
#### C-04: server.rs 中 `std::process::exit(0)` 强制退出
...
#### H-01: database.rs 中 30 处 `.lock().unwrap()` mutex panic 风险
...
#### H-02: udp.rs 中 5 处 `.lock().unwrap()` 在语音热路径
...
#### H-05: server.rs 任务强制 abort 无优雅关闭
...
#### H-07: rpc_handler.rs 封禁检查 "fail open" 策略
...
#### M-07: lua_auth.rs unsafe impl Send/Sync
...
#### M-15: rpc_handler.rs edge current_load 始终为 0
...
#### M-19: server.rs 语音数据在循环中重复 clone
