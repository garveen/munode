    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 20: {
          ...
          message.temporary_access_tokens.push(reader.string());
          continue;
        }
        case 21: {
          if (tag === 168) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.bans.push(BanList_BanEntry.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 16) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.groups.push(ACL_ChanGroup.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.acls.push(ACL_ChanACL.decode(reader, reader.uint32()));
          continue;
        }
        case 5: {
          if (tag !== 40) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.users.push(UserList_User.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.targets.push(VoiceTarget_Target.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.certificates.push(Buffer.from(reader.bytes()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
